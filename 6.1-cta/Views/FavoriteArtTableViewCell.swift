//
//  FavoriteArtTableViewCell.swift
//  6.1-cta
//
...
class FavoriteArtTableViewCell: UITableViewCell {
...
//    MARK: - Setup UI
    ...
    private func constrainNameLabel() {
        ...
        [nameLabel.leadingAnchor.constraint(equalTo: artImageView.trailingAnchor, constant: 5),
    ...
    private func constrainTimeLabel() {
        ...
        [timeLabel.leadingAnchor.constraint(equalTo: artImageView.trailingAnchor, constant: 5),
